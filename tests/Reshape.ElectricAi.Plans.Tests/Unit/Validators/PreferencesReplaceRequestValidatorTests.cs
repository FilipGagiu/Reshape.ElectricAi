...
public sealed class PreferencesReplaceRequestValidatorTests
{
    private readonly PreferencesReplaceRequestValidator _validator = new();

    private static readonly PreferencesReplaceRequest Empty = new(
        Name: null,
        Origin: null,
        Crew: null,
        VibeTags: null,
    ...
    {
        // 60 chars of content padded with 2 leading + 2 trailing spaces (64 raw, 60 trimmed).
        // Mapper trims before length-cap, so raw 64 must still validate cleanly.
